...
public class Probability 
{
	 ...
	 public void count()
	{
		...
		probabilityList = findingProb.getSymptomsList();
		 ...
		 //System.out.println("***" +probabilityList.size());
		...
		// System.out.println(probabilityList.get(1));
		 ...
		 for(int i = 0; i < size; i++)
		 {
			 ...
			 {
				 System.out.println("Before hasCOVID19N " + hasCOVID19N); 
				 hasCOVID19N++;
		 ...
		 System.out.println("After for loop hasCOVID19Y " + hasCOVID19Y);
		 System.out.println("After for loop hasCOVID19N " + hasCOVID19N); 
		 
		 
		 System.out.println("Inside count" +coughYCOVID19Y);
	 ...
	 public void findProb()
	 {
		...
		//probabilityList = findingProb.getSymptomsList();
		 ...
		 System.out.println("Before temp hot" +temperatureHotCOVID19Y);
		 temperatureHotCOVID19Y = temperatureHotCOVID19Y / hasCOVID19Y;
		 System.out.println("After temphot " +temperatureHotCOVID19Y);
		...
		else
		{
		 ...
		 System.out.println("before calc hasCOVID19Y " + hasCOVID19Y);
		 System.out.println("Before calc hasCOVID19N " + hasCOVID19N); 
		 
		 
		 
		//System.out.println("TempY = " +tempY + " AchesY " +achesY+ " SorethroatY " +soreThroatY + " coughY " +coughY+ " DZY " +DZY+ " hasCOVID19Y " +hasCOVID19Y+ " 
		 //hasCOVID19N " +hasCOVID19N);
		...
		//Calculating COVID19Y
		 ...
		 System.out.println("Before *100" + ansY);
		
		 ansY = ansY*100;
		 
		 System.out.println("After *100 " + ansY);
		
		
		//Calculating COVID19N
		
		float ansNo = tempN * achesN * soreThroatN * coughN * DZN * (hasCOVID19N);
